...
Locals data for centosstudio

This file contains a number of anaconda version-specific data for various
parts of the centosstudio process.  All information is stored in nested
...
class LocalsDict(dict):
  ...
  that aids the specific requirements of the centosstudio locals system.
