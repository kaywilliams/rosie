from centosstudio.util.magic import FILE_TYPE_EXT2FS as EXT2
from centosstudio.util.magic import FILE_TYPE_FAT    as FAT32
from centosstudio.util.magic import FILE_TYPE_CPIO   as CPIO
