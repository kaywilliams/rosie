...
from centosstudio.util.img import acquire_mount_point, release_mount_point

from centosstudio.util.img.mountable import MountableImageHandler, MakeMountableImage
