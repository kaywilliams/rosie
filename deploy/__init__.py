...
also easy to extend the basic deploy system by writing your own modules
that implement the deploy module interface.

Support for multiple platform builds - deploy is capable of building a
