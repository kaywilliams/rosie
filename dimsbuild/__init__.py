...
also easy to extend the basic dimsbuild system by writing your own modules that
implement the dimsbuild module interface.  Finally, dimsbuild has full support
for plugins, allowing program execution and output to be further modified.

Support for multiple platform builds - dimsbuild is capable of building a
