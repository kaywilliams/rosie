...
from openprovision.util.pps.lib.mirror import MirrorGroup, validate_mirrorlist
...
from openprovision.util.pps.Path.remote import RemotePath_Printf as MirrorPath_Printf
