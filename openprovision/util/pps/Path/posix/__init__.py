...
from openprovision.util.pps.Path.local import LocalPath_Stat as PosixPath_Stat
from openprovision.util.pps.Path.local import LocalPath_Walk as PosixPath_Walk
