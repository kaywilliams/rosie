...
also easy to extend the basic repostudio system by writing your own modules
that implement the repostudio module interface.

Support for multiple platform builds - repostudio is capable of building a
