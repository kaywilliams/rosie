...
Locals data for repostudio

This file contains a number of anaconda version-specific data for various
parts of the repostudio process.  All information is stored in nested
...
from repostudio.util import versort
...
class LocalsDict(dict):
  ...
  that aids the specific requirements of the repostudio locals system.
