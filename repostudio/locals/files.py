from repostudio.util.magic import FILE_TYPE_EXT2FS as EXT2
from repostudio.util.magic import FILE_TYPE_FAT    as FAT32
from repostudio.util.magic import FILE_TYPE_CPIO   as CPIO
