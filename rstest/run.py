...
from rstest import make_logger
from rstest.runtest import parse_cmd_args # use runtest's cmd parser
...
opt_defaults = dict(
  ...
  version  = '5',
  basearch = 'i386',
  buildroot   = '/tmp/rstest',
  testlogfile = 'test.log',
  testloglevel = 2,
  libpath   = [],
  sharepath = [ pps.path(__file__).dirname.abspath() / '../share/repostudio' ],
