...
also easy to extend the basic systemstudio system by writing your own modules
that implement the systemstudio module interface.

Support for multiple platform builds - systemstudio is capable of building a
