...
from systemstudio.modules.shared import comps, ShelveMixin
...
#------ ERRORS ------#
class NoPackagesOrGroupsSpecifiedError(SystemStudioEventError):
  message = "%(message)s"

class CompsError(SystemStudioEventError): pass
