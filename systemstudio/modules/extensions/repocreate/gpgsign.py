...
from systemstudio.util.mkrpm       import GpgMixin
from systemstudio.util.progressbar import ProgressBar

from systemstudio.callback  import GpgCallback, SyncCallback, LAYOUT_GPG
from systemstudio.errors    import assert_file_has_content, SystemStudioError, SystemStudioIOError
...
class GpgkeyInvalidError(SystemStudioError):
  message = "file '%(file)s' does not appear to be a valid gpg key"

class IncorrectPassphraseError(SystemStudioError):
